...
export default function Hero() {
  return (
    <div id="about" className="relative bg-slate-950 overflow-hidden">
      ...
      <div className="relative max-w-7xl mx-auto py-32 px-4 sm:py-48 sm:px-6 lg:px-8">
        <div className="max-w-3xl">
          ...
          <div className="mt-12 flex flex-col sm:flex-row gap-5">
            <button className="bg-blue-600 text-white px-10 py-4 rounded-full text-lg font-bold hover:bg-blue-500 transition-all shadow-xl shadow-blue-900/20 active:scale-95">
              Support Our Mission
            </button>
